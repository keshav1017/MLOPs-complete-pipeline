...
def load_model(file_path: str):
    ...
    try:
        ...
        logger.error(f"Unexpected error while loading the model.")
        raise
...
def load_data(file_path: str) -> pd.DataFrame:
    ...
    try:
        ...
        logger.error(f"Unexpected error occured while loading test data: {e}")
        raise
...
def save_metrics(metrics: dict, file_path: str) -> None:
    ...
    try:
        ...
        logger.error(f"Error during metircs evaluation: {e}")
        raise
...
def main():
    try:
        ...
        logger.error(f"Failed to evaluate to model evaluation process: {e}")
        print(f"Error: {e}")
